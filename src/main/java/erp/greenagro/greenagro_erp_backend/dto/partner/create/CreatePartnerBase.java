...
@JsonSubTypes({
        @JsonSubTypes.Type(value = CreateBizPartnerRequest.class, name = "BUSINESS"),
        @JsonSubTypes.Type(value = CreateIndPartnerRequest.class, name = "INDIVIDUAL")
})
public abstract class CreatePartnerBase {
    ...
    //private PartnerType partnerType; //사업자 유형 (법인사업자, 개인사업자, 개인) - 요청시 포함해야함
